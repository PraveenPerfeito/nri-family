...
| Page-hero previews (9) | [product-preview/previews/](../../src/components/product-preview/previews/) | One screen per page (/services and every service page, For NRIs, How It Works, Trust); sample data in [src/data/previews.ts](../../src/data/previews.ts); see [ui-v2.md](ui-v2.md#page-hero-product-previews-2026-09-25) |
